...
TEST_F(FlatBuffersTest, Basic) {
  ...
  std::vector<flatbuffers::Offset<flatbuffers::String>> path_names;
  path_names.emplace_back(builder.CreateString("foo"));
  path_names.emplace_back(builder.CreateString("bar"));*/
